...
const T3AGENT_DRIVER_KIND = ProviderDriverKind.make("t3agent");
...
export const DEFAULT_MODEL_BY_PROVIDER: Partial<Record<ProviderDriverKind, string>> = {
  ...
  [T3AGENT_DRIVER_KIND]: "claude-sonnet-5",
};
...
> = {
  ...
  [OPENCODE_DRIVER_KIND]: "openai/gpt-5",
  [T3AGENT_DRIVER_KIND]: "claude-haiku-4-5",
};
