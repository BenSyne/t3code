...
import { connectAgent } from "./agent/model/connectAgent.ts";
  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      return WsRpcGroup.of({
        ...
        [WS_METHODS.serverConnectAgent]: (input) =>
          observeRpcEffect(WS_METHODS.serverConnectAgent, connectAgent(input), {
            "rpc.aggregate": "server",
          }),
